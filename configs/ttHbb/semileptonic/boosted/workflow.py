...
from pocket_coffea.lib.objects import btagging, jet_selection
...
from doublebtagging import bbtagging

class ttHbbBoostedProcessor(ttHbbBaseProcessor):
    ...
    def apply_object_preselection(self, variation):
        ...
        self.events["BFatJetGood"] = bbtagging(
            self.events["FatJetGood"],
            self.params.btagging.working_point[self._year],
            wp=self.params.object_preselection.FatJet["doublebtag"]["wp"]
        )
    ...
    def count_objects(self, variation):
        ...
        self.events["nLightJetGood"] = ak.num(self.events.LightJetGood)
        self.events["nFatJetGood"]   = ak.num(self.events.FatJetGood)
        self.events["nBFatJetGood"]  = ak.num(self.events.BFatJetGood)
