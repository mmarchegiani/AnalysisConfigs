...
cfg = Configurator(
    ...
    variables = {
        ...
        **fatjet_hists(coll="FatJetGood", pos=0, axis_settings=axis_settings),
        **fatjet_hists(coll="FatJetGood", pos=1, axis_settings=axis_settings),
        **fatjet_hists(coll="BFatJetGood", pos=0, axis_settings=axis_settings),
        **fatjet_hists(coll="BFatJetGood", pos=1, axis_settings=axis_settings),
        **fatjet_taggers_hists(name="fatjet", coll="FatJetGood", fields=["btagDDBvLV2", "btagDDCvBV2", "btagDDCvLV2", "particleNet_HbbvsQCD"], pos=0),
        **fatjet_taggers_hists(name="fatjet", coll="FatJetGood", fields=["btagDDBvLV2", "btagDDCvBV2", "btagDDCvLV2", "particleNet_HbbvsQCD"], pos=1),
        **fatjet_taggers_hists(name="fatjet", coll="BFatJetGood", fields=["btagDDBvLV2", "btagDDCvBV2", "btagDDCvLV2", "particleNet_HbbvsQCD"], pos=0),
        **fatjet_taggers_hists(name="fatjet", coll="BFatJetGood", fields=["btagDDBvLV2", "btagDDCvBV2", "btagDDCvLV2", "particleNet_HbbvsQCD"], pos=1),
